...
const Konsultasi = () => {
  return (
    <div
      className="flex flex-col justify-center items-center h-auto md:h-[500px] mx-auto my-auto"
      style={{ background: "linear-gradient(#7D8797 50%, #ffffff 50%)" }}
    >
      <h1 className="text-[#112340] text-2xl md:text-[32px] mt-28 md:mt-0 leading-[38px] text-center font-semibold">
